...
int main(int argc, char** argv) {
  ...
  //
  // Real applications may use tb->start() which returns, allowing the
  // foreground thread to proceed, then later use tb->stop(), followed by
  // tb->wait(), to cleanup GNU Radio before exiting.
  tb->run();
